...
def compute_saliency_maps(X, y, model):
    ...
    # backward
    torch.autograd.backward(scores, grad_tensors=torch.ones_like(y, dtype=torch.float))
...
def make_fooling_image(X, target_y, model):
    ...
    while True:
        ...
        X_fooling.grad.data.zero_() # reset the gradient

        if idx.squeeze().item() == target_y:
            break
